...
import (
	...
	vaultcommon "github.com/smartcontractkit/chainlink-common/pkg/capabilities/vault"
)
...
func TestBuildWorkflowGetSecretsRequestID(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			t.Parallel()
			assert.Equal(t, tt.want, vaultcommon.BuildWorkflowGetSecretsRequestID(tt.md))
		})
	}
}
